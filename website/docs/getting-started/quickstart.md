...
- [Automatic workflow](../user-guide/automatic) - detailed parameter guide for `auto_est_cont`
- [DecontX](../user-guide/decontx) - per-cell probabilistic decontamination
- [Downstream analysis](../user-guide/downstream) - PCA, UMAP, clustering, DE on corrected data
